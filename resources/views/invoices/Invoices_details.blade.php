...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">invoices-details</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    invoices
                    details</span>
            </div>
        </div>
                                                    ...
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($attachments as $attachments)
                                                                ...
                                                                <td>{{ $i }}</td>
                                                                <td><a
                                                                        href="{{ asset('Attachment/' . $attachments->file_name) }}">
                                                                        {{ $attachments->file_name }}</a> </td>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <a class="btn btn-outline-info btn-sm"
                                                                        href="{{ url('download') }}/{{ $attachments->file_name }}"
                                                                        role="button"><i
