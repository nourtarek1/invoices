            ...
            <li class="side-item side-item-category">Main</li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'paid_bills')) }}">paid bills</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'unpaid_bills')) }}">unpaid bills</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'partially')) }}">partially paid bills</a>
                        </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'Role')) }}">Role</a></li>
                    </ul>
                </li>
              
                <li class="side-item side-item-category">Addition</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">Addition</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">section</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'proudects')) }}">proudects</a></li>
